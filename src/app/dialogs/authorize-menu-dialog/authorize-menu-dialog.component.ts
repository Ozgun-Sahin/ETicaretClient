...
export class AuthorizeMenuDialogComponent extends BaseDialog<AuthorizeMenuDialogComponent> implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    this.assignedRoles = await this.autorizationEndpointService.getRolesToEndpoint(this.data.code, this.data.menuName);
  ...
  assignRoles(rolesComponent: MatSelectionList) {
    ...
    this.autorizationEndpointService.assignRoleEndpoint(roles, this.data.code, this.data.menuName, () => {
